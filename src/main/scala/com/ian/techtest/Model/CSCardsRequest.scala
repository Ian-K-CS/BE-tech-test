...
//  5. To test - send this new scala obj with all the card details from Partner 1 - CSCards to the user, no eligability filtering or anything, just return everything.
